...
🔭 I’m currently working on  `Ralph` a home monitoring system controlled through the cloud and `Beat Rate`- a platform where musicians can pay for criticism from normal consumers!
